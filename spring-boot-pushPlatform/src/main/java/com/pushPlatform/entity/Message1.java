...
//	private static final long serialVersionUID = 1L;
	...
	public Message1(String _id, String guid, Integer readStatus, String category, String title, String message) {
		super();
		this._id = _id;
		this.guid = guid;
	...
	public Message1(String guid, Integer readStatus, String category, String title, String message) {
		super();
		this.guid = guid;
		this.readStatus = readStatus;
		this.category = category;
